...
Rumus Jalur Main Berdasarkan 2D Harian (keakuratan 80%)
2D JALUR | 2D JALUR | 2D JALUR
01 1–3 | 51 2–3 | 51 2–3
02 1–2 | 52 1–3 | 52 1–3
03 2–3 | 53 1–2 | 53 1–2
... (tabel lengkap seperti yang diberikan pengguna)

Lemah diambil dari jumlah 2D harian:
...
TABEL EKOR DIAMBIL DARI EKOR :
0 => 4 5 6 9 0 1 | 5 => 9 0 1 4 5 6
1 => 5 6 7 0 1 2 | 6 => 0 1 2 5 6 7
2 => 6 7 8 1 2 3 | 7 => 1 2 3 6 7 8
3 => 7 8 9 2 3 4 | 8 => 2 3 4 7 8 9
4 => 8 9 0 3 4 5 | 9 => 3 4 5 8 9 0
---
`;


const buildPrompt = (lotteryType: LotteryType, market: string, lastResult?: string[]): string => {
  const digitCount = lotteryType.charAt(0);
