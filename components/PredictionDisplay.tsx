...
const PredictionCategory: React.FC<{ 
  ...
  <div className={`bg-slate-700/50 rounded-lg p-4 text-center ${className || ''}`} style={style}>
...
Salam dari 𝗠𝗮𝘀 𝗔𝗥𝗝`;
  ...
  return (
    <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-6 shadow-2xl border border-slate-700">
      <h2 
        className="text-2xl sm:text-3xl font-bold text-center mb-6 animate-fade-in-up" 
      ...
      <div 
        className="mt-6 relative bg-slate-700/50 p-4 rounded-lg text-slate-300 whitespace-pre-wrap font-mono animate-fade-in-up"
